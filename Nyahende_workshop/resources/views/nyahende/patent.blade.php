...
<head>
    ...
    <title>Nyahende Workshop | Patent No</title>
</head>
...
<div class="thisdesc" >
    <h1 class="productheading" style="color:white">Our biggest achievements </h1>
        <p class="servicespara" style="padding:10px;color:white">In the year of 2014 and 2016 we were greatefull to register our workshop
            to the government authority and we were given a certificate of grant patent.
        </p> 
...
<div class="achievementsimg">
    <img src="{{asset('/images/patent.jpg')}}" alt="" class="vetaimg" >
</div>
</div>
</div>
