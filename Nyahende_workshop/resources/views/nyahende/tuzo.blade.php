...
<head>
    ...
    <title>Nyahende Workshop | Tuzo</title>
</head>
...
<div class="thisdesc">
    ...
    <a href="ventilator" style="color:white">7</a>
        ...
        <p class="servicespara" style="padding:10px;color:white">In the year of 2014 were delighted to receive an award from the government
            being recognized as the Best invetor of Farming Technology.
        </p> 
        <div class="achievementsimg">
    <img src="{{asset('/images/tuzo.jpg')}}" alt="" class="vetaimg">
</div>
</div>
</div>
</div>
