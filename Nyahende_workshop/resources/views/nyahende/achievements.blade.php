...
<head>
    ...
    <title>Nyahende Workshop | Achievements</title>
</head>
...
<div class="thisdesc">
    <h1  class="productheading" style="color:white">Our biggest achievements </h1>
        <p class="servicespara" style="padding:10px;color:white">The Worksop offically came into life back in 1996 when the first incubator was made.
            From there we had many achievements which includes the modification of our product, awards,nominations
            interviews and invention of new products.Some of the notable achievements are shown on this site.
        </p>
        <div class="paginationachieve">
    <a href="achievements" style="color:white"s>1</a>
