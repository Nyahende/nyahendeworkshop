...
<head>
    ...
    <title>Nyahende Workshop | Ventilator</title>
</head>
...
<div class="back-display" style="background:url({{asset('backgroundimages/snowflakes.jpg')}});height:150">
<div class="servicedesc" style="background:url({{asset('backgroundimages/moon.jpg')}})" >
<div class="thisdesc">
    <h1 class="productheading" style="color:white">Other Ongoing Projects </h1>
    ...
    <a href="ventilator" style="color:white">7</a>
        ...
        <p class="servicespara" style="padding:10px;color:white">
            As stated in the previous page, we also manufacture portable ventilators
            though are not ready for distribution as we are still waiting for government
            certification.The ventilator can use the atmospheric oxygen or a tanked oxygen.
            it can use a normal electricity it consumes very little power and it can also 
            use car battery(which means you can use it while inside your car for an emergence).
            another advantage that it has comparing to the common ventilators is that it is very simple
            to use as it does not require any prior knowledge or medical experts and it can easily be 
            from one point to another without any complications(as the name implies 'Portable Ventiltor').
        </p> 
        <div class="achievementsimg">
    <img src="{{asset('/images/ventilator.jpg')}}" alt="" class="vetaimg" >
</div>
</div>
</div>
</div>
