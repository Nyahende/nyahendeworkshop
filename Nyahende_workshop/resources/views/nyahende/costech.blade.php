...
<head>
    ...
    <title>Nyahende Workshop | Costech Award</title>
</head>
...
<div class="thisdesc">
    ...
    <a href="ventilator" style="color:white">7</a>
        ...
        <p class="servicespara" style="padding:10px;color:white">Also In the year of 2019 we were pleased to receive an award from the 
            commission of science and technology(COSTECH) being recognized as grass-root innovator for 
            making eggs incubator
        </p> 
        <div class="achievementsimg">
    <img src="{{asset('/images/costech.jpg')}}" alt="" class="vetaimg">
</div>
</div>
</div>
</div>
